...
<section id="testimonials" class="py-20 bg-gradient-to-br from-gray-50 to-white">
    <div class="container mx-auto px-6">
        ...
        <div class="relative max-w-6xl mx-auto">
            <!-- Navigation Arrows -->
            <button class="testimonial-prev absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white p-3 rounded-full shadow-lg hover:bg-primary hover:text-white transition-all duration-300 transform hover:scale-110 focus:outline-none">
                <i class="fas fa-chevron-left text-primary text-xl hover:text-white"></i>
            </button>
            <button class="testimonial-next absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white p-3 rounded-full shadow-lg hover:bg-primary hover:text-white transition-all duration-300 transform hover:scale-110 focus:outline-none">
                <i class="fas fa-chevron-right text-primary text-xl hover:text-white"></i>
            </button>
            
            <!-- Testimonial Carousel -->
            <div class="testimonial-carousel overflow-hidden px-12">
                <div class="flex transition-transform duration-500 ease-in-out">
                    <!-- Testimonial 1 -->
                    <div class="testimonial-slide min-w-[calc(33.333%-1rem)] px-2 py-8 transition-all duration-300">
                        <div class="bg-white p-6 rounded-xl shadow-md h-full transform transition-all duration-300 hover:shadow-lg border-t-4 border-primary/30">
                            <div class="flex items-center mb-4">
                                <div class="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold mr-3">JD</div>
                                <div>
                                    <h4 class="font-semibold text-dark">John Doe</h4>
                                    <p class="text-gray-500 text-xs">Event Organizer</p>
                                </div>
                            </div>
                            <p class="text-gray-600 text-sm mb-3">"TicketyHub made selling tickets for our charity gala so simple. The platform is intuitive and customer support was excellent."</p>
                    ...
                    <!-- Testimonial 2 -->
                    <div class="testimonial-slide min-w-[calc(33.333%-1rem)] px-2 py-8 transition-all duration-300">
                        <div class="bg-white p-6 rounded-xl shadow-md h-full transform transition-all duration-300 hover:shadow-lg border-t-4 border-secondary/30">
                            <div class="flex items-center mb-4">
                                <div class="w-10 h-10 rounded-full bg-secondary/10 flex items-center justify-center text-secondary font-bold mr-3">AS</div>
                                <div>
                                    <h4 class="font-semibold text-dark">Alice Smith</h4>
                                    <p class="text-gray-500 text-xs">Music Festival</p>
                                </div>
                            </div>
                            <p class="text-gray-600 text-sm mb-3">"We've used several ticketing platforms, but TicketyHub stands out for reliability and great features. Real-time analytics are a game-changer."</p>
                            <div class="text-yellow-400 text-sm">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                    ...
                    <div class="testimonial-slide min-w-[calc(33.333%-1rem)] px-2 py-8 transition-all duration-300">
                        <div class="bg-white p-6 rounded-xl shadow-md h-full transform transition-all duration-300 hover:shadow-lg border-t-4 border-primary/30">
                            <div class="flex items-center mb-4">
                                <div class="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold mr-3">RJ</div>
                                <div>
                                    <h4 class="font-semibold text-dark">Robert Johnson</h4>
                                    <p class="text-gray-500 text-xs">Conference</p>
                                </div>
                            </div>
                            <p class="text-gray-600 text-sm mb-3">"Customizable ticket options allowed us to create exactly what we needed. Attendees loved the mobile tickets!"</p>
                            <div class="text-yellow-400 text-sm">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                    ...
                    <div class="testimonial-slide min-w-[calc(33.333%-1rem)] px-2 py-8 transition-all duration-300">
                        <div class="bg-white p-6 rounded-xl shadow-md h-full transform transition-all duration-300 hover:shadow-lg border-t-4 border-secondary/30">
                            <div class="flex items-center mb-4">
                                <div class="w-10 h-10 rounded-full bg-secondary/10 flex items-center justify-center text-secondary font-bold mr-3">MS</div>
                                <div>
                                    <h4 class="font-semibold text-dark">Maria Sanchez</h4>
                                    <p class="text-gray-500 text-xs">Theater Director</p>
                                </div>
                            </div>
                            <p class="text-gray-600 text-sm mb-3">"The box office management tools saved us countless hours during our busy season. Highly recommend for performing arts organizations!"</p>
                            <div class="text-yellow-400 text-sm">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                    ...
                    <div class="testimonial-slide min-w-[calc(33.333%-1rem)] px-2 py-8 transition-all duration-300">
                        <div class="bg-white p-6 rounded-xl shadow-md h-full transform transition-all duration-300 hover:shadow-lg border-t-4 border-primary/30">
                            <div class="flex items-center mb-4">
                                <div class="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold mr-3">TK</div>
                                <div>
                                    <h4 class="font-semibold text-dark">Tom Kennedy</h4>
                                    <p class="text-gray-500 text-xs">Sports Events</p>
                                </div>
                            </div>
                            <p class="text-gray-600 text-sm mb-3">"Season ticket management has never been easier. Our fans love the mobile integration and our staff loves the reporting tools."</p>
                            <div class="text-yellow-400 text-sm">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                    ...
                    <div class="testimonial-slide min-w-[calc(33.333%-1rem)] px-2 py-8 transition-all duration-300">
                        <div class="bg-white p-6 rounded-xl shadow-md h-full transform transition-all duration-300 hover:shadow-lg border-t-4 border-secondary/30">
                            <div class="flex items-center mb-4">
                                <div class="w-10 h-10 rounded-full bg-secondary/10 flex items-center justify-center text-secondary font-bold mr-3">LP</div>
                                <div>
                                    <h4 class="font-semibold text-dark">Lisa Patel</h4>
                                    <p class="text-gray-500 text-xs">University Events</p>
                                </div>
                            </div>
                            <p class="text-gray-600 text-sm mb-3">"Perfect for our student organization events. The free tier gives us everything we need for small campus gatherings."</p>
                            <div class="text-yellow-400 text-sm">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
            ...
            <div class="flex justify-center mt-6 space-x-2">
                <button class="w-2 h-2 rounded-full bg-gray-300 dot-indicator" data-index="0"></button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateCarousel() {
        ...
        carousel.querySelector('.flex').style.transform = `translateX(-${currentIndex * slideWidth}px)`;
        ...
        // Update dots
        const activeDotIndex = Math.floor(currentIndex / (totalSlides / dots.length));
    ...
    dots.forEach(dot => {
        dot.addEventListener('click', () => {
            clearInterval(autoSlideInterval);
            currentIndex = parseInt(dot.dataset.index) * 2; // 2 slides per dot
            updateCarousel();
            startAutoSlide();
        });
    });
